<template>
  <!-- Use header instead of container. Container add right margin by default but not the header -->
  <div
    class="py-2 bg-gradient-to-t from-green-600 to-green-500 p-4 overflow-hidden"
  >
